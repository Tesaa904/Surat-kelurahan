...
$tahun = date ('Y');
$nomor = "/SKD/".$romawi."/".$tahun;
// membaca kode  terbesar dari penomoran yang ada didatabase berdasarkan tanggal
$query = "SELECT max(no_surat_skd) as maxKode FROM surat_ket_umum";
...
<div class="pageheader">
		<h3><i class="fa fa-pencil"></i> Pengajuan Surat Keterangan Domisili</h3>
	</div>
	<!--Page content-->
	<!--===================================================-->
	<div id="page-content">
			...
			<div class="col-md-12">
				<section class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Isi Data Domisili </h3>
					</div>
								...
								<tr>
									<td style="text-align:left">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="no_surat_skd"  value="<?php echo $nomorbaru;?>" readonly="readonly">
										...
										<div class="form-group">
											...
											<select type="text" name="nik"class="form-control selectpicker" data-live-search="true" autofocus="on">
								...
								<!--		</div>	
										...
										<div class="form-group">
											...
											<select type="hidden" name="id_jenis_surat" class="form-control hidden">
												...
												<?php
													$sql = mysqli_query($mysqli,"SELECT * FROM m_jenis_surat WHERE id_jenis_surat='1'ORDER BY id_jenis_surat");
													while($row1 = mysqli_fetch_assoc($sql)){
