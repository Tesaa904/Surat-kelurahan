    ...
    <div id="">
       <img align="left"style="width: 13%;" src="../../assets/images/LOGO_KLATEN.png">
          ...
          <div id="isi">
            <table  align="center"> 
                 <tr>
                  <td><h4>SURAT KETERANGAN DOMISILI</h4></td>
                </tr>
                <tr>
                  <td align="center"> Nomer :<?php echo $umum['no_surat_skd'];?></td>
                </tr>
                </table>
                <hr>
           ...
           <table>
            ...
            <table style="text-align: left;">
              <tr>
                <td>
                <p style="text-align: justify;">Dengan ini menerangkan bahwa orang yang bersangkutan benar tinggal berdomisili di Desa Kraguman, Kecamatan Jogonalan, Kabupaten Klaten.<br> Demikian surat keterangan domisili ini kami buat sebagaimana perlunya semoga dapat digunakan semestinya. Dan kepada yang berkepentingan agar menjadi maklum</p>
              </td>
              </tr>
            </table>
            <br>
