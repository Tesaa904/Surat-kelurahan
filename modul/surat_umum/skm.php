...
<div class="pageheader">
		<h3><i class="fa fa-pencil"></i>  Pengajuan Surat Kurang Mampu </h3>
	</div>
	<!--Page content-->
	<!--===================================================-->
	<div id="page-content">
			...
			<div class="col-md-12">
				<section class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Isi Data Pengajuan Surat Kurang Mampu  </h3>
					</div>
								...
								<tr>
									<td style="text-align:left">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="penghasilan"  placeholder="Masukkan penghasilan orang tua dalam 1 bulan">
