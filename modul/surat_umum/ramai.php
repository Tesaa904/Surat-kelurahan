...
$tahun = date ('Y');
$nomor = "/SIR/".$romawi."/".$tahun;
// membaca kode  terbesar dari penomoran yang ada didatabase berdasarkan tanggal
$query = "SELECT max(no_surat_sir) as maxKode FROM surat_ket_umum";
...
<div class="pageheader">
		<h3><i class="fa fa-pencil"></i>  Pengajuan Surat Ijin Keramaian </h3>
	</div>
	<!--Page content-->
	<!--===================================================-->
	<div id="page-content">
			...
			<div class="col-md-12">
				<section class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Isi Data Pengajuan Surat Ijin Keramaian </h3>
					</div>
								...
								<tr>
									<td style="text-align:left">
										...
										<div class="form-group">
											...
											<input class="form-control" id="id_ket_umum" name="id_ket_umum"  type="hidden"  />
											<input type="hidden" class="form-control" name="no_surat_imb" >
											...
											<input type="text" class="form-control" name="no_surat_sir"  value="<?php echo $nomorbaru;?>" readonly="readonly">
										...
										<div class="form-group">
											...
											<select type="text" name="nik" class="form-control selectpicker" data-live-search="true">
									...
									<!--	</div> -->
										<div class="form-group">
											<label class="control-label">Tanggal dan Pukul keperluan</label>
													<div class="form-inline">
													<input class="datepicker form-control form-control-sm" name="tgl_keperluan" type="text" placeholder="thn-bln-tgl"/>
													<span class="fa fa-calendar"></span>
										
												<input class="form-control" name="pukul_kegiatan" type="time" placeholder="masukan Waktu acara" />
													</div>
												</div>
										<div class="form-group">
											...
											<select type="hidden" name="id_jenis_surat" class="form-control hidden">
												...
												<?php
													$sql = mysqli_query($mysqli,"SELECT * FROM m_jenis_surat WHERE id_jenis_surat='2'ORDER BY id_jenis_surat");
													while($row1 = mysqli_fetch_assoc($sql)){
								...
								<tr>
									<td style="text-align:left">
										...
										<div class="form-group">
											...
											<input type="hidden" class="form-control" name="nama_usaha">
											<input type="hidden" class="form-control" name="alamat_usaha">
											<select type="hidden" class="form-control hidden"name="jenis_bangunan" required="required">
													<option>-</option>
												...
												<input type="hidden" class="form-control" name="letak"  placeholder="Letak luas tanah/banguan">
												<input type="hidden" class="form-control" name="status_tanah"  placeholder="Status kepemilikan tanah">
											...
											<input type="file" class="form-control" name="file_suratketumum">
