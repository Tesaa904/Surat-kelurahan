...
$tahun = date ('Y');
$nomor = "/SKT/".$romawi."/".$tahun;
// membaca kode  terbesar dari penomoran yang ada didatabase berdasarkan tanggal
$query = "SELECT max(no_surat_skt) as maxKode FROM surat_ket_umum";
								...
								<tr>
									<td style="text-align:left">
										<div class="form-group">
											...
											<input class="form-control" id="" name="id_ket_umum" value="<?php echo $kodeBarang;?>"  type="hidden"  />
											<input type="hidden" class="form-control" name="no_surat_imb" >
											<input type="text" class="form-control" name="no_surat_skt" value="<?php echo $nomorbaru;?>" readonly="readonly">
										...
										<div class="form-group">
											...
											<select type="text" name="nik" class="form-control select2">
												<option name="nik" value="" selected="selected" autofocus="on">Pilih</option>
												<?php
										...
										<div class="form-group">
											...
											<select type="hidden" name="id_jenis_surat" class="form-control hidden">
												...
												<?php
													$sql = mysqli_query($mysqli,"SELECT * FROM m_jenis_surat WHERE id_jenis_surat='4'ORDER BY id_jenis_surat");
													while($row1 = mysqli_fetch_assoc($sql)){
								...
								<tr>
									<td style="text-align:left">
										<div class="form-group">
											...
											<label class="control-label"> Penghasilan Orang Tua Per Bulan</label>
											<input type="text" class="form-control" name="penghasilan"  placeholder="Penghasilan Orang tua/Wali">
											<label class="control-label"> Upload Foto</label>
                                                                                        <input class="form-control" name="id_status_surat" type="hidden" value="2">	
											<input type="file" class="form-control" name="file_suratketumum"  placeholder="Masukkan Foto pengantar RT/RW">
