					...
					<form role="form" action="modul/ketumum/proses.php?act=add" method="post" enctype="multipart/form-data">
									...
									<!--	</div>
										...
										<div class="form-group">
											...
											<select type="hidden" name="id_jenis_surat" class="form-control hidden">
												...
												<?php
													$sql = mysqli_query($mysqli,"SELECT * FROM m_jenis_surat WHERE id_jenis_surat='6'ORDER BY id_jenis_surat");
													while($row1 = mysqli_fetch_assoc($sql)){
						...
						<div class="row setup-content" id="step-2">
							<table class="table">
								<tr>
									<th colspan="2">
										<h3> Perubahan Data & Berkas Pengajuan Surat</h3>
									</th>
								</tr>
								<tr>
									<td style="text-align:left">
									...
									<!--	</div>		-->							<select type="hidden" class="form-control hidden"name="jenis_bangunan" required="required">
												...
												<label class="control-label">Data Yang Salah</label>
												<input type="text" class="form-control" name="data_ubah"  placeholder=" Isi data Yang Akan Diubah">
												<label class="control-label">Data Yang Benar</label>
											<input type="text" class="form-control" name="data_benar"  placeholder=" isi data yang benar">
