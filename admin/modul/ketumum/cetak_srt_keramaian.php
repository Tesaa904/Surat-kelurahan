    ...
    <div id="">
       <img align="left"style="width: 13%;" src="../../assets/images/LOGO_KLATEN.png">
          ...
          <div id="isi">
            <table  align="center"> 
                 <tr>
                  <td><h4>SURAT KETERANGAN Keramaian</h4></td>
                </tr>
                <tr>
                  <td align="center"> Nomer :<?php echo $umum['no_surat_sir'];?></td>
                </tr>
                </table>
                <hr>
           ...
           <table>
             ...
             <table>
                ...
                <tr>
                 ...
                 <tr>
                  <td>Tanggal Kegiatan</td><td></td><td>: <?php echo date($umum['tgl_keperluan']); ?></td>
                </tr>
                <tr>
                  <td>Pukul Kegiatan</td><td></td><td>: <?php echo $umum['pukul_kegiatan']; ?></td>
                </tr>
                <tr>
                  <td>Alamat Acara</td><td></td><td>: <?php echo $umum['alamat_acara']; ?></td>
                </tr>
                <tr>
            ...
            <table style="text-align: left;">
              <tr>
                <td>
                <p style="text-align: justify;">Menerangkan bahwa orang tersebut diatas adalah benar-benar warga desa kami.<?php echo $umum['keterangan'];?>.<br> Demikian surat keterangan domisili ini kami buat sebagaimana perlunya semoga dapat digunakan semestinya. Dan kepada yang berkepentingan agar menjadi maklum</p>
              </td>
              </tr>
            </table>
            <br>
...
<?php
    $filename="surat_keterangan_ramai.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
    //==========================================================================================================
