    ...
    <div id="">
       <img align="left"style="width: 13%;" src="../../assets/images/LOGO_KLATEN.png">
          ...
          <div id="isi">
            <table  align="center"> 
                 <tr>
                  <td><h4>SURAT KETERANGAN PERUBAHAN</h4></td>
                </tr>
                <tr>
                  <td align="center"> Nomer :<?php echo $umum['no_surat_skp'];?></td>
                </tr>
                </table>
                <hr>
           ...
           <table>
             ...
             <table>
                ...
                <tr>
                  <td>Tempat Tinggal</td><td></td><td>: <?php echo $umum['nama_dukuh']; ?> RT <?php echo $umum['rt']; ?>/ RW <?php echo $umum['rw']; ?></td>
                </tr>
            ...
            <table>
              <tr>
                <td>
                  Bahwa yang bersangkutan tercatat sebagai berikut :
                </td>
              </tr>
            </table>
            ...
            <table>
              <tr>
                <td>Data Yang Salah</td><td></td><td>: <?php echo $umum['data_ubah']; ?>  </td>
              </tr>
              <tr>
                <td>Data Yang Yang benar</td><td></td><td>: <?php echo $umum['data_ubah']; ?>  </td>
              </tr>
            </table>
            <br>
            <br>
            <table style="text-align: left;">
              <tr>
                <td>
                <p style="text-align: justify;"><?php echo $umum['keterangan']; ?><br> Demikian surat keterangan ini kami buat sebagaimana perlunya semoga dapat digunakan semestinya. Dan kepada yang berkepentingan agar menjadi maklum</p>
              </td>
              </tr>
            </table>
            <br>
...
<?php
    $filename="surat_keterangan_domisili.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
    //==========================================================================================================
