...
$tahun = date ('Y');
$nomor = "/SKU/".$romawi."/".$tahun;
// membaca kode  terbesar dari penomoran yang ada didatabase berdasarkan tanggal
$query = "SELECT max(no_surat_sku) as maxKode FROM surat_ket_umum";
...
<div class="pageheader">
	<h3><i class="fa fa-pencil"></i> Pengajuan Surat Keterangan Usaha </h3>
	</div>
	<!--Page content-->
	<!--===================================================-->
	<div id="page-content">
			...
			<div class="col-md-12">
				<section class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Isi Data Usaha </h3>
					</div>
					...
					<form role="form" action="modul/surat_umum/proses.php?act=add" method="post" enctype="multipart/form-data">
								...
								<tr>
									<td style="text-align:left">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="no_surat_sku" value="<?php echo $nomorbaru;?>"  readonly="readonly">
										</div>		
										<div class="form-group">
						...
						<div class="row setup-content" id="step-2">
							<table class="table">
								<tr>
									<th colspan="2">
										<h3> Alamat Usaha & Berkas Pengajuan Surat</h3>
									</th>
								</tr>
								<tr>
									<td style="text-align:left">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="nama_usaha" onkeyup="this.value = this.value.toUpperCase()"  placeholder="Nama Usaha Yang dimiliki">
										</div>	
										<div class="form-group">
											<label class="control-label">Alamat Usaha </label>
											<input type="text" class="form-control" name="alamat_usaha"  placeholder="Alamat Usaha">
