    ...
    <div id="">
       <img align="left"style="width: 13%;" src="../../assets/images/LOGO_KLATEN.png">
          ...
          <div id="isi">
            <table  align="center"> 
                 <tr>
                  <td><h4>SURAT KETERANGAN MENDIRIKAN BANGUNAN</h4></td>
                </tr>
                <tr>
                  <td align="center">Nomer :<?php echo $umum['no_surat_imb'];?></td>
                </tr>
                </table>
                <hr>
           ...
           <table>
               ...
               <tr>
                   <td>Nama</td><td></td><td>: <?php echo $user['nama']; ?></td>
                 </tr>
                 <tr>
                   <td>Jabatan</td><td></td><td>: KEPALA DESA</td>
               </tr>
             ...
             <table>
              ...
              <table>
                <tr>
                  <td style="text-align: justify;"><br>Yang Bersangkutan mengajukan permohonan izin untuk:<br><br> Mendirikan bangunan baru/ bangunan tambahan/ mengubah sebagian atau seluruh bagunan/ membongkar sebagian atau seluruh bangunan :</td>
                </tr>
              </table>
              <table>
                <tr>
                  <td>Terletak diatas persil</td><td></td><td> : <?php echo $umum['letak']; ?></td>
                </tr>
                <tr>
                  <td>Status Tanah</td><td></td><td> : <?php echo $umum['status_tanah']; ?></td>
                </tr>
            </table>
            <br>
            <br>
            <table>
              <tr>
                <td>
                <p style="text-align: justify;"><?php echo $umum['keterangan'];?>.<br> Demikian surat keterangan domisili ini kami buat sebagaimana perlunya semoga dapat digunakan semestinya. Dan kepada yang berkepentingan agar menjadi maklum</p>
              </td>
              </tr>
            </table>
            <br>
...
<?php
    $filename="surat_keterangan_bangunan.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
    //==========================================================================================================
