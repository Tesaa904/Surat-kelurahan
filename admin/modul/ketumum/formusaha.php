								...
								<tr>
									<td style="text-align:left">
										<div class="form-group">
											...
											<input class="form-control" name="id_ket_umum" value="<?php echo $kodeBarang;?>" type="hidden"  />
								...
								<tr>
									<td style="text-align:left">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="nama_usaha"  placeholder="Nama Usaha Yang dimiliki">
										</div>	
										<div class="form-group">
