...
include "../../config/database.php";
  ...
  include "../../config/function.php";
    ...
    $umum =mysqli_fetch_array(mysqli_query($mysqli,"SELECT a.*,b.nama,c.nama_dukuh,c.rt,c.rw,d.nama_jenis_surat,e.email FROM surat_ket_umum a LEFT JOIN m_penduduk b ON a.nik=b.nik LEFT JOIN m_jenis_surat d ON a.id_jenis_surat=d.id_jenis_surat LEFT JOIN m_dukuh c ON b.id_dukuh=c.id_dukuh LEFT JOIN m_akun_penduduk e ON a.id_akun =e.id_akun WHERE a.id_status_surat='2' AND a.id_jenis_surat='$post_surat' AND a.nik='$get_nik' AND CAST(a.tgl_surat AS DATE) BETWEEN '$tgl_awal' AND '$tgl_akhir'"));
    ...
    <div id="">
       <img align="left"style="width: 13%;" src="../../assets/images/LOGO_KLATEN.png">
          ...
          <div id="isi">
            <table  align="center"> 
                 <tr>
                  <td><h4>SURAT KETERANGAN USAHA</h4></td>
                </tr>
                <tr>
                  <td align="center"> Nomer :<?php echo $umum['no_surat_sku'];?></td>
                </tr>
                </table>
                <hr>
           ...
           <table>
             ...
             <table>
                ...
                <tr>
                 ...
                 <tr>
                  <td>Alamat Tinggal</td><td></td><td>: <?php echo $umum['nama_dukuh']; ?>RT <?php echo $umum['rt']; ?>/ RW <?php echo $umum['rw']; ?></td>
                </tr>

                 <tr>
                  <td>Surat Bukti Diri</td><td></td><td>: NIK: <?php echo $umum['nik']; ?>/ KK: <?php echo $identitas['no_kk']; ?></td>
                </tr>
                <tr>
                  <td>Keperluan</td><td></td><td>: <?php echo $umum['keperluan']; ?></td>
                </tr>
                <tr>
                  <td>Alamat Usaha</td><td></td><td>: <?php echo $umum['alamat_usaha']; ?></td>
                </tr>
            </table>
            <br>
            <br>
            <table style="text-align: left;">
              <tr>
                <td>
                <p style="text-align: justify;">Menerangkan bahwa orang tersebut diatas adalah benar-benar warga desa kami dan benar-benar memiliki usaha<?php echo $umum['nama_usaha'];?>.<br> Demikian surat keterangan domisili ini kami buat sebagaimana perlunya semoga dapat digunakan semestinya. Dan kepada yang berkepentingan agar menjadi maklum</p>
              </td>
              </tr>
            </table>
            <br>
...
<?php
    $filename="surat_keterangan_umum.pdf"; //ubah untuk menentukan nama file pdf yang dihasilkan nantinya
    //==========================================================================================================
