...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>:</td>
    <td style="text-align:left"><?php echo $data[0]['nama_tempat_dilahir'] ?></td>
  </tr>
    <tr>
...
<table class="table table-striped">
  ...
  <tr>
    <th> NIK Saksi 1</th>
    <td>:</td>
    <td style="text-align:left"><?php echo $data[0]['nik_sk1'] ?></td>
  </tr>
  <tr>
    <th>Nama</th>
    <td>:</td>
    <td style="text-align:left"><?php echo name_from_nik($data[0]['nik_sk1']) ?></td>
  </tr>
  <tr>
    <th> NIK Saksi 2</th>
    <td>:</td>
    <td style="text-align:left"><?php echo $data[0]['nik_sk2'] ?></td>
  </tr>
  <tr>
    <th>Nama</th>
    <td>:</td>
   <td style="text-align:left"><?php echo name_from_nik($data[0]['nik_sk2']) ?></td>
  </tr>
</div>
</table>
<h3>C. Data Daerah</h3>
