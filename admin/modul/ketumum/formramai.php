		...
		<div class="card">
			<div class="card-body">
				...
				<div class="container">
					...
					<form role="form" action="modul/ketumum/proses.php?act=add" method="post" enctype="multipart/form-data">
								...
								<tr>
									...
									<!--	<div class="form-group">
										...
										<div class="form-inline">
												...
												<input type="time" class="form-control" name="pukul_kegiatan" >
												</div>
											</div>
										<div class="form-group">
								...
								<tr>
									<td style="text-align:left">
										<div class="form-group">
											...
											<input type="hidden" class="form-control" name="data_benar"  placeholder="">
											<input type="hidden" class="form-control" name="penghasilan"  placeholder="">
