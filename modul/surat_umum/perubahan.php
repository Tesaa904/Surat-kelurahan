...
$tahun = date ('Y');
$nomor = "/SKP/".$romawi."/".$tahun;
// membaca kode  terbesar dari penomoran yang ada didatabase berdasarkan tanggal
$query = "SELECT max(no_surat_skp) as maxKode FROM surat_ket_umum";
...
?>
	<div class="pageheader">
		<h3><i class="fa fa-pencil"></i> Input Data Pengajuan Surat Keterangan Perubahan data </h3>
	</div>
	<!--Page content-->
	<!--===================================================-->
	<div id="page-content">
			...
			<div class="col-md-12">
				<section class="panel">
					<div class="panel-heading">
						<h3 class="panel-title">Form Data yang akan diubah </h3>
					</div>
						...
						<div class="container">
							...
							<form role="form" action="modul/surat_umum/proses.php?act=add" method="post" enctype="multipart/form-data">
								<div class="row setup-content" id="step-1">
									<table class="table">
										...
										<tr>
											...
											<input type="text" class="form-control" name="no_surat_skp"   value="<?php echo $nomorbaru;?>" readonly="readonly">
									...
									<!--	</div>
										...
										<div class="form-group">
											...
											<select type="hidden" name="id_jenis_surat" class="form-control hidden">
												...
												<?php
													$sql = mysqli_query($mysqli,"SELECT * FROM m_jenis_surat WHERE id_jenis_surat='3'ORDER BY id_jenis_surat");
													while($row1 = mysqli_fetch_assoc($sql)){
								...
								<div class="row setup-content" id="step-2">
									...
									<!--	</div>		--><select type="hidden" class="form-control hidden"name="jenis_bangunan" required="required">
													<option>-</option>
											...
											<div class="form-group">
											<label class="control-label">Data Yang Benar </label>
												<input type="text" class="form-control" name="data_ubah"  placeholder="Isi data yang ingin diubah">
											</div>
											<div class="form-group">
												<label class="control-label">Data Yang Diubah </label>
												<input type="text" class="form-control" name="data_benar"  placeholder="Masukkan data yang benar">
